...
export function createDesigner(vueInstance) {
  ...
  return {
    ...
    checkWidgetMove(evt) { /* Only field widget can be dragged into sub-form */
      ...
      // console.log("(this.$tableDb",this.$tableDb)
      // indexDb.addData(this.$tableDb, "history", evt);
    ...
    onDragEnd(evt,index){
      // console.log("evtEnd0000000",evt)
      // console.log("evtEnd0000000",index)
    },
    onDragStart(evt,index){
      console.log("evtstart0000000",evt)
      console.log("evtstart0000000",index)
    ...
    copyNewContainerWidget(origin) {
      console.log("origin00000000000000",origin);
      origin.u_id = generateId()
      // if(origin.type==1 ||  origin.type==2 ||  origin.type==3 ||  origin.type==4) return;
